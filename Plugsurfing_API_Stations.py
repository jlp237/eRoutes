...
def getStationData (min_lat, max_lat, min_long, max_long):
    ...
    encodedBodyStations = json.dumps({"station-get-surface": {"min-lat": min_lat,"max-lat": max_lat,"min-long": min_long,
                                                       "max-long": max_long}})
    ...
    stationPrices = pd.DataFrame(columns = ['Station_ID', 'Name', 'Latitude', 'Longitude', 'Type', 'Charging_Speed', 'Charging_per_kwh'])
